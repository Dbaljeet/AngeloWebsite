...
`
const Arrow = ({ width, left, onClick, color, title }) =>{
    return(
        
        <>
        <ARROW width={width} left={left} onClick={onClick} color={color}>
            <svg width={width} height="100%" role="img" aria-labelledby="Arrow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title id="Arrow" >{title}</title>
